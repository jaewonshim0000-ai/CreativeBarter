...
export default function NewProjectPage() {
  ...
  return (
    <div className="max-w-2xl mx-auto">
      <h1 className="font-display text-3xl mb-8">Create New Project</h1>

      {error && (
        <div className="bg-red-50 text-red-700 px-4 py-3 rounded-lg text-sm mb-6">{error}</div>
      )}

      <form onSubmit={handleSubmit} className="space-y-6 bg-white rounded-2xl p-8 border border-surface-200">
        {/* Title */}
        <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            ...
            />
            <p className="text-xs text-surface-800 mt-1">Comma-separated</p>
          </div>
          <div>
